document.addEventListener("DOMContentLoaded", function () {
    ...
    function createSparkle() {
        ...
        // Assign a random color to the sparkle
        const colors = ['#FF5733', '#33FF57', '#3357FF', '#F333FF', '#FF33A8', '#FFD133'];
...
function displayCourses(filter = "all") {
    ...
    filteredCourses.forEach((course) => {
        ...
        courseItem.innerHTML = `<a href="#">${course.subject} ${course.number} ${course.completed ? '✔️' : ''}</a>`;
